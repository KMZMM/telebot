    ...
    with open(combo_file, 'r') as file:
        for P in file.readlines():
            ...
            try:
                ...
                yy = yy[-2:]  # Only take the last two digits of the year
                cvc = cvc.strip()

                # Replace time.sleep() with asyncio.sleep() for non-blocking delay
                ...
                await asyncio.sleep(10)  # Wait before sending the next request
