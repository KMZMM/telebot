...
# Global variable to track if checking is in progress
...
✘ By ➠ KMZ BOT'''
        ...
        await update.message.reply_text('Finished checking all cards!')
    except Exception as e:
        logger.error(f"Error in process_combo: {e}")
        await update.message.reply_text("An error occurred while processing cards. Please try again.")
